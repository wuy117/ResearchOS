  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        '{"records":[{"title":"string","date":"YYYY-MM-DD or empty string","term":"string or null","academicYear":"string or null","subject":"string","assessmentType":"exam|report|coursework|music|mock|other","teacher":"string or null","teacherComment":"string or null","effort":"string or null","attainment":"string or null","score":number|null,"maxScore":number|null,"percentage":number|null,"grade":"string or null","predictedGrade":"string or null","targetGrade":"string or null","rank":"string or null","marksExtracted":boolean,"strengths":["string"],"weaknesses":["string"],"actionPoints":["string"]}],"message":"string"}',
        '',
        'Document text:',
        text.slice(0, 12000),
      ].join('\n'),
