  ...
  return [
    {
      ...
      content: [
        ...
        'Use confidence levels to decide review friction: High and Medium should normally be accepted automatically; Low means the user should confirm before analytics trust that field.',
      ].join(' '),
    },
    {
      role: 'user' as const,
